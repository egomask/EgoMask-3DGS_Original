...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, depth, feature_map, radii, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args) #############
        ...
        return color, depth,feature_map, radii ###

    @staticmethod
    ### def backward(ctx, grad_out_color, _):
    def backward(ctx, grad_out_color, grad_depth, grad_out_feature,  _):
